...
class App(TKMT.ThemedTKinterFrame):
    def __init__(self, theme, mode, usecommandlineargs=True, usethemeconfigfile=True):
        ...
        self.leftframe.Button("Tall Button", None, gridkwargs={'rowspan':2}) #buttons can span rows
        self.leftframe.Button("Wide Button", None, col=1, gridkwargs={'columnspan':2}) #buttons can span cols

        #if a button is large enough, it will extend past the edge of the frame
        self.leftframe.Button("Very wide button", None, col=1, gridkwargs={'columnspan':5})
        self.leftframe.Button("Very tall button", None, col=1, gridkwargs={'rowspan': 3})
        ...
        self.leftframe.Button("Because this button overlaps!", None, col=2, row=3)

        #this will throw an error because a button overlaps with reserved space
        self.leftframe.Button("Half hidden button.", None, col=3, row=2, gridkwargs={'columnspan': 2, 'rowspan': 2})
        ...
        self.rightframe.Button("B", None, gridkwargs={'columnspan': 2})
