...
# Modified from the forest theme, a beautiful and modern ttk theme inspired by Excel.

package require Tk 8.6

namespace eval ttk::theme::park-dark {

    variable version 1.0
    package provide ttk::theme::park-dark $version
    variable colors
    array set colors {
        -fg             "#eeeeee"
        -bg             "#313131"
    ...
    # Settings
    ttk::style theme create park-dark -parent default -settings {
        ttk::style configure . \
